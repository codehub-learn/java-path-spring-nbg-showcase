...
public abstract class BaseServiceImpl<T extends BaseModel> extends BaseComponent implements BaseService<T, Long> {
	...
	public abstract BaseInternalMapper<T> getInternalMapper();
	...
	@Override
	public void update(final Long id, final T item) {
		logger.trace("Updating {}.", item);
		var retrievedItem = get(id);
		getInternalMapper().update(item, retrievedItem);
	}
